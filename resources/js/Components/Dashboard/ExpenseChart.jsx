...
export default function ExpenseChart({ weeklyExpenses, monthlyExpenses, topCategories }) {
    ...
    // Data untuk Weekly
    const weeklyData = weeklyExpenses || [];
    ...
    const currentTitle = viewType === 'weekly' ? 'Pengeluaran 7 Hari Terakhir' : 'Pengeluaran 12 Bulan Terakhir';
